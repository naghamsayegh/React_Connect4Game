...
export const isWinner = (
  ...
  //gameBoard is passed by reference (it's an array)
  let board = [...gameBoard];
...
export const getRandomComputerMove = (gameBoard: any) => {
  let validMoves = [];
...
const getPosition = (gameBoard: any, moveChecks: any) => {
...
export const getComputerMove = (gameBoard: any) => {
  let moveChecks = [
    //vertical
    {
      index: [0, 4, 8, 12],
